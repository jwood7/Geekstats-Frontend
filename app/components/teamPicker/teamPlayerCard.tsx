    ...
    return (
        <div className="flex drop-shadow bg-neutral-800 w-full h-fit rounded-xl text-white overflow-clip gap-2.5">
            <div className="bg-gold p-2.5">
                <div className="w-20 h-20 bg-neutral-500 my-auto rounded overflow-clip">{process.env.NEXT_PUBLIC_IMAGE_URL && <img src={process.env.NEXT_PUBLIC_IMAGE_URL + "/images/geeks/" + "yakobay" + ".png"}/> }</div>
            </div>
